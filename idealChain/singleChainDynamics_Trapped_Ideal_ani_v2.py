...
if initConfig == "F": # Fully Extendedからスタートする場合
    savefile = "./gif/SingleChain_Dynamics_N{0}_{1}steps_FE_in_{2}-Tube".format(N, t_max, radi)
if initConfig == "R": # Random Coilからスタートする場合
    savefile = "./gif/SingleChain_Dynamics_N{0}_{1}steps_RC_in_{2}-Tube".format(N, t_max, radi)
