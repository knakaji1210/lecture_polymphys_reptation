...
import singleChainDynamicsFunc_Trapped_FloryHuggins_v0 as scd
...
if initConfig == "F": # Fully Extendedからスタートする場合
    savefile = "./gif/SingleChain_Dynamics_FloryHuggins_N{0}_{1}steps_FE_in_D{2}-Tube".format(N, t_max, 2*radi)
if initConfig == "R": # Random Coilからスタートする場合
    savefile = "./gif/SingleChain_Dynamics_FloryHuggins_N{0}_{1}steps_RC_in_D{2}-Tube".format(N, t_max, 2*radi)
